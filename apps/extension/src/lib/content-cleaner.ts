import { stripInvisibleChars } from './unicode-text';
...
export function cleanContent(markdown: string): string {
  ...
  // 1. Strip invisible Unicode characters (BOM, LTR/RTL marks, zero-width
  //    spaces, and the invisible math operators KaTeX has no metrics for).
