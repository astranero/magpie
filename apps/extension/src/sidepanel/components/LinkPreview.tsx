    ...
    <div className="absolute inset-0 z-50 flex flex-col bg-background animate-in fade-in slide-in-from-bottom-4 motion-reduce:animate-none">
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar px-4 py-3">
        {preview.loading ? (
          ...
          <div className="prose prose-sm dark:prose-invert max-w-none prose-img:rounded-md prose-headings-display prose-a:text-primary prose-code:text-foreground prose-pre:bg-muted/80 prose-pre:text-foreground prose-pre:rounded-md prose-pre:border prose-pre:border-border">
            <ReactMarkdown
            ...
            >
              {stripInvisibleMathOps(preview.markdown || '')}
            </ReactMarkdown>
          </div>
        )}
      </div>
